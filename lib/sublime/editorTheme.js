const { getColor, hexToRgb } = require('../util')
...
module.exports = function({ colors, name }) {
  ...
  const theme = [
    ...
    {
      class: 'tab_label',
      settings: ['${settingsName}tabs_font_small'],
      'font.size': 10.0,
    },
    {
      class: 'tab_label',
      settings: ['${settingsName}tabs_font_normal'],
      'font.size': 11.0,
    },
    {
      class: 'tab_label',
      settings: ['${settingsName}tabs_font_large'],
      'font.size': 12.0,
    },
    {
      class: 'tab_label',
      settings: ['${settingsName}tabs_font_xlarge'],
      'font.size': 14.0,
    },
    ...
    {
      class: 'sidebar_tree',
      settings: ['${settingsName}sidebar_tree_xsmall'],
      row_padding: [8, 0],
    },
    {
      class: 'sidebar_tree',
      settings: ['${settingsName}sidebar_tree_small'],
      row_padding: [8, 2],
    },
    {
      class: 'sidebar_tree',
      settings: ['${settingsName}sidebar_tree_normal'],
      row_padding: [8, 4],
    },
    {
      class: 'sidebar_tree',
      settings: ['${settingsName}sidebar_tree_large'],
      row_padding: [8, 6],
    },
    {
      class: 'sidebar_tree',
      settings: ['${settingsName}sidebar_tree_xlarge'],
      row_padding: [8, 8],
    },
    ...
    {
      class: 'sidebar_label',
      settings: ['${settingsName}sidebar_font_small'],
      'font.size': 10.0,
    },
    {
      class: 'sidebar_label',
      settings: ['${settingsName}sidebar_font_normal'],
      'font.size': 11.0,
    },
    {
      class: 'sidebar_label',
      settings: ['${settingsName}sidebar_font_large'],
      'font.size': 12.0,
    },
    {
      class: 'sidebar_label',
      settings: ['${settingsName}sidebar_font_xlarge'],
      'font.size': 14.0,
    },
    ...
    // Highlight results button
    {
      ...
      'layer0.tint': hexToRgb(getColor(colors, ['list.highlightForeground'])),
      'layer0.opacity': 1,
      content_margin: 8,
    },
    {
    ...
    //
    {
      ...
      attributes: ['expanded'],
      'layer0.tint': hexToRgb(getColor(colors, ['sideBar.foreground'])),
    },
...

    {
      ...
      fg: hexToRgb(getColor(colors, ['titleBar.activeForeground'])),
      bg: hexToRgb(getColor(colors, ['titleBar.activeBackground'])), // -00
    },
  ]
  return theme
}
